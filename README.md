...
- [x] **Visually appealing colors and layout. No overflowing elements.** - I added a nice background and even figured out how to do a vignette.
- [x] **Use of a CSS framework** - I used a drop down from bootstrap.
- [x] **All visual elements styled using CSS** - Everything is done with css.
- [x] **Responsive to window resizing using flexbox and/or grid display** - Everything resizes with the window.
- [x] **Use of a imported font** - I downloaded "rye" which matches the style I was wanting.
- [x] **Use of different types of selectors including element, class, ID, and pseudo selectors** - I used quite a variety, but mostly classes.
...
- [X] **All functionality implemented or mocked out** - Obviously other players can't join yet, but if left alone it looks liek they join your lobby and play.
- [X] **Hooks** - I have more than enough of those.
...
- [X] **Calls to third party endpoints** - Yes Gemini from the back and a quote one from the front.
- [X] **Backend service endpoints** - Yes... so many.
...
- [X] **Stores data in MongoDB** - Stores game game data
- [X] **Stores credentials in MongoDB** - Yes.
